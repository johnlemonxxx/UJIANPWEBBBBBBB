...
<body>
  ...
  <main>
        ...
        <div class="overlay">
          ...
          <div class="profile-wrap">
            <div class="profile">
              ...
              <a href="" target="_blank"><i class="fab fa-instagram fa-fw"></i>@john_lemooon</a>
            </div>
            ...
            <div class="profile">
              ...
              <a href="" target="_blank"><i class="fab fa-instagram fa-fw"></i>@joschris_</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="information" class="information">
      ...
      <div class="dates">
        <p class="date">31</p>
        <p class="month">Desember<br>2025</p>
      </div>
    ...
    <section id="rsvp">
      ...
      <article class="countdown-wrapping countdown">
        <h2>Desember 31<sup>th</sup>, 2025</h2>
